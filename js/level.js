...
const level = {
    ...
    playableLevels: ["fattypattyhouse","labs", "rooftops", "skyscrapers", "warehouse", "highrise", "office", "aerie", "satellite", "sewers", "testChamber", "pavilion"],
    communityLevels: ["fattypattyhouse","stronghold", "basement", "crossfire", "vats", "run", "n-gon", "house", "perplex", "coliseum", "tunnel", "islands", "temple", "dripp", "biohazard"],
    ...
    difficultyText() {
        if (simulation.difficultyMode === 1) {
            ...
            return "why"
        } else if (simulation.difficultyMode === 8) {
			return "fattypatty mode"
		}
    ...
    fattypattyhouse() {
        level.custom = () => {
            ctx.fillStyle = "#000" //light fixtures
            ctx.fillRect(-920, -505, 40, 10)
            ctx.fillRect(-920, 95, 40, 10)
            ctx.fillRect(180, 95, 40, 10)
            ctx.fillRect(-20, 695, 40, 10)
		...
		powerUps.spawn(935,-130,"gun")
		powerUps.spawn(935,-130,"research")
		m.energy += 9000000000
	
		powerUps.spawn(935,-130,"heal")
		powerUps.spawn(935,-130,"tech")
		 spawn.mapRect(100, -599, 60, 185);
        spawn.mapRect(775, -124, 335, 35);
        spawn.mapRect(825, -99, 35, 110);
        spawn.mapRect(1005, -99, 35, 110);
        spawn.bodyRect(1000, -149, 85, 35);
        spawn.bodyRect(985, -149, 85, 35);
		...
		spawn.mapRect(1235,43,3000,100);
		spawn.mapRect(2540,40,30,-100);
		powerUps.spawn(2540,40,"heal");
		powerUps.spawn(2540,40,"heal");
		powerUps.spawn(2540,40,"heal");
		powerUps.spawn(2540,40,"heal");
		spawn.mapRect(2540,540,10000,100);
		//secret pocket area full of tech. This area is visible if you continue going out of the map from the exit door
		powerUps.spawn(3100,560,"tech");
		powerUps.spawn(3100,560,"tech");
		powerUps.spawn(3100,560,"tech");
		powerUps.spawn(3100,560,"tech");
		powerUps.spawn(3100,560,"tech");
		...
		powerUps.spawn(3100,560,"tech");
		powerUps.spawn(3100,560,"tech");
		spawn.randomLevelBoss(2900, 560, ["shooterBoss", "spiderBoss", "launcherBoss", "laserTargetingBoss", "dragonFlyBoss", "laserBoss"]);
		spawn.randomLevelBoss(2900, 560, ["shooterBoss", "spiderBoss", "launcherBoss", "laserTargetingBoss", "dragonFlyBoss", "laserBoss"]);
		spawn.randomLevelBoss(2900, 560, ["shooterBoss", "spiderBoss", "launcherBoss", "laserTargetingBoss", "dragonFlyBoss", "laserBoss"]);
		spawn.randomLevelBoss(2900, 560, ["shooterBoss", "spiderBoss", "launcherBoss", "laserTargetingBoss", "dragonFlyBoss", "laserBoss"]);
        ...
        if (Math.random() < 0.5) {
            ...
            spawn.bodyRect(-2325, 1250, 50, 50);
            spawn.bodyRect(-2275, 1350, 125, 50);
			spawn.bodyRect(-2375,1500,150,100);
			spawn.mapRect(-3148,50,90,10000);
