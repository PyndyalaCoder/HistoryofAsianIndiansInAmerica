const tech = {
    ...
    tech: [{
        ...
        },
        {
            ...
            description: "Remove concept of <i><mark><strong>energy</strong></mark></i> from game; anything that uses energy is free. However, when another energy tech is paired with this tech, it may result in energy becoming a concept again, with a limited (high, but still limited) amount of energy attached to you.",
            maxCount: 9,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
		...
		{
            name: "dark sacrifice",
            description: "sacrifice <i>health</i> for more max <strong>energy.</strong>",
            maxCount: 9,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
		...
		{
            name: "light sacrifice",
            description: "sacrifice <i>energy</i> for more max <strong>health</strong>.",
            maxCount: 9,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
            allowed() { return true },
            requires: "not dark sacrifice",
            effect() {
				m.maxEnergy -= 0.5
				m.maxHealth += 1
            },
		...
		{
            name: "dual sacrifice",
            description: "sacrifice <strong>energy</strong> and <strong>health</strong> in order to <strong>spawn</strong> <mark>tech</mark>",
            maxCount: 9,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
		...
		{
            name: "Supercharged Drones",
            description: "<i>Drones</i> are sent to </i><strong><mark>random</mark></strong></i> positions on the screen when <strong>shot</strong>. Knockback still pushes player away from mouse pointer.",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
            allowed() {
                return (tech.haveGunCheck("Double Helix Motor Drones") && !tech.isNailShot && !tech.isIceShot && !tech.isRivets && !tech.isFoamShot && !tech.isSporeWorm && !tech.isSporeFlea && !tech.isNeedles) || (tech.haveGunCheck("super balls") && !tech.isFoamBall) || (tech.isRivets && !tech.isNailCrit) || (m.fieldUpgrades[m.fieldMode].name === "molecular assembler" && simulation.molecularMode === 3) || (tech.haveGunCheck("drones") && !tech.isForeverDrones && !tech.isDroneRadioactive && !tech.isDroneTeleport)
            },
            requires: "Double Helix Motor Drones",
            effect() {
                tech.isOverfedDrone = true;
            },
            remove() {
                tech.isOverfedDrone  = false;
            }
        },
